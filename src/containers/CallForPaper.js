        ...
        <>
            ...
            <Grid container className="">
                ...
                <Grid item xs={12} className="p-5 pt-10">
                    <h className="">The journal is now entering its 7 th cycle and we are delighted to invite submissions from
                        academicians, professionals, industry experts etc.,on ‘Azadi ka Amrit Mahotsav –
                        Transformation of Law and Justice in the last 75 years’.</h>
                    <br /><br />
                    <h>‘Azadi Ka Amrit Mahotsav’ is an initiative of the Indian government to celebrate and
                        ...
                        freedom struggle of India.</h>
                    <br /><br />
                    <h>The period after Indian independence was one of great optimism, as the basic institutional
                    ...
                    <div>
                        <Grid container className="">
                            ...
                            <Grid item xs={6} className="">
                                ...
                                <h><b>FORMAT AND CITATION GUIDELINES:</b></h>
                                <br />
